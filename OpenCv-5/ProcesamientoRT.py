...
# Modos de ejecucion
#(SE EJECUTAN CON EL TECLADO CADA NUMERO Y SUS NUMEROS EN CODIGO ASCII)
...
#(LO PODEMOS VER COMO UN DICCIONARIO DE DETECCION DE ESQUINAS)
